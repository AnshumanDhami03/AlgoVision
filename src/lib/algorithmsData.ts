...
export interface AlgorithmInfo {
  ...
  // videoUrl?: string; // Removed videoUrl property
}
    ...
    algorithms: [
      {
        ...
        icon: ArrowDownUp,
        // videoUrl: "/videos/bubble-sort.mp4", // Removed
      },
      {
        ...
        icon: LocateFixed,
        // videoUrl: "/videos/selection-sort.mp4", // Removed
      },
      {
        ...
        icon: LogIn,
        // videoUrl: "/videos/insertion-sort.mp4", // Removed
      },
      {
        value: 'merge-sort',
        label: 'Merge Sort',
        ...
        icon: GitMerge,
        // videoUrl: "/videos/merge-sort.mp4", // Removed
      },
      {
        value: 'quick-sort',
        label: 'Quick Sort',
        ...
        icon: Divide,
        // videoUrl: "/videos/quick-sort.mp4", // Removed
      },
    ]
  },
  search: {
    ...
    algorithms: [
      {
        ...
        icon: MoveRight,
        // videoUrl: "/videos/linear-search.mp4", // Removed
      },
      {
        value: 'binary-search',
        label: 'Binary Search',
        ...
        icon: SearchCode,
        // videoUrl: "/videos/binary-search.mp4", // Removed
      },
    ]
  },
  graph: {
    ...
    algorithms: [
      {
        ...
        icon: Network,
        // videoUrl: "/videos/prims-algorithm.mp4", // Removed
      },
      {
        ...
        icon: LinkIcon,
        // videoUrl: "/videos/kruskals-algorithm.mp4", // Removed
      },
    ]
  }
};
